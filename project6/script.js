...
var cwd = $("#currentWeather");
var fd = $("#weatherForecast");
var cities;
...
function returnUVIndex(coordinates) {
    ...
    $.get(queryURL).then(function(response){
        ...
        cwd.append(`<p>UV Index: <span class="text-${textColour} uvPadding" style="background-color: ${uvSeverity};">${currUVIndex}</span></p>`);
    })
}
